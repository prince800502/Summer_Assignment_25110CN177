#include<bits/stdc++.h>
#include<fstream>        //This Header is to use file Handling (mujhe samajhne ke liye)
using namespace std;
struct employee{
    string Name;
    int EmpNo;
...
void savetofile(employee e[], int employee_no){
    ...
    for(int i=0;i<employee_no;i++){
        ...
        fout<<e[i].EmpNo<<endl;
        fout<<e[i].age<<endl;
        fout<<e[i].basic_salary<<endl;
        fout<<e[i].bonus<<endl;
        fout<<e[i].deduction<<endl;
        fout<<e[i].net_salary<<endl;
    }
...
void loadfromfile(employee e[], int &employee_no){
    ...
    while(employee_no < 1000 && getline(fin, e[employee_no].Name)){
        ...
        if(!(fin >> e[employee_no].EmpNo >> e[employee_no].age >> e[employee_no].basic_salary >> e[employee_no].bonus >> e[employee_no].deduction >> e[employee_no].net_salary)){
...
int main(){
    ...
    cout<<"3. Search Salary Record"<<endl;
    cout<<"4. Update Salary Record"<<endl;
    cout<<"5. Delete Salary Record"<<endl;
    cout<<"6. Exit"<<endl;
    cin>>main_opt;

//Adding Employee Salary Record
    ...
    if(main_opt == 1){
        ...
        cin>>e[i].deduction;
        e[i].net_salary = e[i].basic_salary + e[i].bonus - e[i].deduction;
        cin.ignore();
        }
        employee_no += n;
    ...
    //Display all Salary Records
        ...
        for(int i=0;i<employee_no;i++){
            ...
            cout<<"Net Salary: "<<e[i].net_salary<<endl<<endl;
        }
    }
    }


    //Searching of Salary Record 
    ...
    //Update Salary Record
        ...
        e[i].net_salary = e[i].basic_salary + e[i].bonus - e[i].deduction;
        savetofile(e,employee_no);
        cout<<"Employee Salary Data updated succesfully"<<endl;
        found = true;
        break;
            }
        }
    ...
    //Delete Salary Record
        ...
        for(int i=0;i<employee_no;i++){
            ...
            for(int j=i;j<employee_no-1;j++){
             ...
             employee_no--;
             savetofile(e,employee_no);
             cout<<"Employee Salary Data deleted successfully"<<endl;
                found3 =true;
                 break;
        }
    }
